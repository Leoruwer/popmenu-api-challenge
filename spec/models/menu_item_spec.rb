...
RSpec.describe MenuItem, type: :model do
  ...
  describe "scopes" do
    ...
    it "returns only vegan items" do
      expect(MenuItem.vegan).to contain_exactly(item_vegan)
    end

    it "returns only lactose_free items" do
      expect(MenuItem.lactose_free).to contain_exactly(item_lactose)
    end

    it "returns only gluten_free items" do
      expect(MenuItem.gluten_free).to contain_exactly(item_gluten)
    end
  end
